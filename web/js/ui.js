...
UI.prototype.modal = function (html, title, func) {
    ...
    var okBtn = "";
    if(func.cancelText){
        cancelBtn = "<button type='button' class='btn' data-dismiss='modal' id='modal_area_button_cancel' style='background-color:rgb(169, 169, 169)'>" + func.cancelText + "</button>";
    }
    if(func.okText){
        okBtn = "<button type='button' class='btn' id='modal_area_button_ok'>" + func.okText + "</button>";
    }
